...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Questionnaire_Control p_Questionnaire_Control;
        ...
        public static SteamVR_Input_ActionSet_Questionnaire_Control Questionnaire_Control
        {
            get
            {
                return SteamVR_Actions.p_Questionnaire_Control.GetCopy<SteamVR_Input_ActionSet_Questionnaire_Control>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Questionnaire_Control = ((SteamVR_Input_ActionSet_Questionnaire_Control)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Questionnaire_Control>("/actions/Questionnaire_Control")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Questionnaire_Control};
        }
    }
}
