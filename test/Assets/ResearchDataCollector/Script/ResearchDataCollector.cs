...
public class ResearchDataCollector : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        System.IO.Directory.CreateDirectory("Assets/ResearchDataCollector/Questionair/Answers/");
        if (screenCapture)
        {
    ...
    {
        File.WriteAllText("Assets/ResearchDataCollector//Questionair/Answers/" + filename + "log.json", JsonConvert.SerializeObject(LocalLoggerList));
    }
