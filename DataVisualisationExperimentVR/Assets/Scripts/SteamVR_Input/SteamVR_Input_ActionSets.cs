...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_DataVisualisation p_DataVisualisation;
        ...
        public static SteamVR_Input_ActionSet_DataVisualisation DataVisualisation
        {
            get
            {
                return SteamVR_Actions.p_DataVisualisation.GetCopy<SteamVR_Input_ActionSet_DataVisualisation>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_DataVisualisation = ((SteamVR_Input_ActionSet_DataVisualisation)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_DataVisualisation>("/actions/DataVisualisation")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.DataVisualisation};
        }
    }
}
